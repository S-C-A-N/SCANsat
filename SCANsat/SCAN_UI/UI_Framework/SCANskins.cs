...
namespace SCANsat.SCAN_UI.UI_Framework
{
	...
	class SCANskins: SCAN_MBE
	{
		...
		internal static Texture2D SCAN_MechJebYellowIcon;
		internal static Texture2D SCAN_TargetIcon;
		internal static Texture2D SCAN_TargetYellowIcon;
		...
		private static void initializeTextures()
		{
			...
			SCAN_MechJebYellowIcon = GameDatabase.Instance.GetTexture("SCANsat/Icons/SCAN_MechJebYellowIcon", false);
			SCAN_TargetIcon = GameDatabase.Instance.GetTexture("SCANsat/Icons/SCAN_TargetIcon", false);
			SCAN_TargetYellowIcon = GameDatabase.Instance.GetTexture("SCANsat/Icons/SCAN_TargetYellowIcon", false);
		}
