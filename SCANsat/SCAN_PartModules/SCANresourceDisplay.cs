...
//        [KSPField(guiActive = true, groupName = "SCANResource", groupDisplayName = "Resources")]
//        public string OreAbundance = "";
...
//        private List<SCANresourceGlobal> currentResources;

//        private BaseEvent _resourceDisplay;

//        private BaseField _abundanceField;

//        private string currentResourceName = "Ore";
...
//            _resourceDisplay = Events["SwitchResource"];
//            _abundanceField = Fields["abundanceField"];

//            _abundanceField.guiName = Localizer.Format("#autoLOC_SCANsat_Abundance");
...
//            activated = true;
//            refreshState = true;
//            currentResourceDisplayName = SCANUtil.displayNameFromResource(currentResourceName);
...
//        {
//            currentResources = SCANcontroller.resources();

//            KSPField attr = new KSPField();
//            attr.groupDisplayName = "Resources";
//            attr.groupName = "SCANResource";
//            attr.guiActive = true;

//            for (int i = 0; i < currentResources.Count; i++)
//            {
//                SCANresourceGlobal global = currentResources[i];

//                _fieldInfos.Add(new FieldInfo());

//                part.Fields.Add(new BaseField(attr, null, this));
//            }
//        }

//        private List<ModuleResourceScanner> findScanners()
//        {
//            return part.FindModulesImplementing<ModuleResourceScanner>().Where(r => r.ScannerType == 0 && r.ResourceName == currentResourceName).ToList();
//        }
...
//            _abundanceField.guiName = string.Format("{0}[{1}]", currentResourceDisplayName, Localizer.Format("#autoLOC_SCANsat_Surface"));
//        }
...
//            if (!activated)
//            {
//                _abundanceField.guiActive = false;
//                return;
//            }
...
//            _abundanceField.guiActive = true;
...
//            {
//                abundanceValue = SCANUtil.ResourceOverlay(lat, lon, currentResourceName, vessel.mainBody, RequiresUnlock && SCAN_Settings_Config.Instance.BiomeLock);
//                fuzzy = false;
//            }
...
//                Where(a => a.ResourceName == currentResourceName && a.HarvestType == HarvestTypes.Planetary && a.BodyId == bodyID).
...
//        [KSPEvent(guiName = "Switch Resource", unfocusedRange = 3, active = true, guiActiveUnfocused = true, externalToEVAOnly = true, guiActive = true, guiActiveEditor = false)]
...
namespace SCANsat.SCAN_PartModules
{
    public class SCANresourceDisplay : PartModule, IAnimatedModule
    {
        [KSPField(guiActive = true, groupName = "SCANResourceDisplayGroup", groupDisplayName = "SCAN Resources", groupStartCollapsed = true)]
        ...
        private void Update()
        {
            ...
            {
                if (fuzzy)
                    abundance = abundanceValue.ToString("P0");
                else
            ...
            else
            {
                float biomeAbundance = abundanceSummary.ContainsKey(biome) ? abundanceSummary[biome].Abundance : 0f;
                if (fuzzy)
                    abundance = string.Format("{0} avg.", biomeAbundance.ToString("P0"));
                else
